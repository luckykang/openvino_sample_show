...
def main():
    ...
    model_xml = "/home/kang/Downloads/public/human-pose-estimation-0001/FP32/human-pose-estimation-0001.xml"
    model_bin = "/home/kang/Downloads/public/human-pose-estimation-0001/FP32/human-pose-estimation-0001.bin"
    ...
    cap = cv2.VideoCapture("/home/kang/Desktop/head-pose.mp4")

    #2) Use GSTREAMER
    #cap = cv2.VideoCapture('filesrc location=road.mp4 !  decodebin ! videoconvert !appsink sync=false', cv2.CAP_GSTREAMER)

    #3) Use media-SDK,由于这个云平台没有集成显卡，所以我们不支持MEDIA-SDK，这里代码只做参考，无>法运行
    ...
    with open('/home/kang/Desktop/labels.txt', 'r') as f:
    ...
    while cap.isOpened():
        ...
        #Print Frame number
        sys.stdout.write("\nFrame  " + str(frame_num)+'       ')
        sys.stdout.write('%.5s' %  decode_time)
